...
public class CustomerDAO extends DataAccessObject<Customer> {
    private final static String INSERT = "INSERT INTO customer(first_name, last_name," +
            " email, phone, address, city, state, zipcode) VALUES (?,?,?,?,?,?,?,?)";
    private final static String GET_ONE = "SELECT customer_id,first_name,last_name," +
            "email, phone, address, city, state, zipcode FROM customer WHERE customer_id=?";
    private final static String UPDATE ="UPDATE customer SET first_name = ? , last_name = ? , " +
